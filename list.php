<?php 
	...
	//DB의 정보를 가져와야 하기 때문에 상단에 DB 연동 파일 인클루드 함
	...
	<body>
		...
		<div class="container">
			<div id="board_area"> 
			  ...
			  <table class="table table-striped" style="text-align: center; border: 1px solid #ddddda; border-collapse: collapse;" >
			  	<tr>
			    ...
			    <?php 
			    	...
			    	while($board = $sql2->fetch_array()){ //결과 $board에 담기
			    		...
			    		if(strlen($title)>30){
							...
							// 이렇게 30byte는 너무 작음...
							$title = mb_strimwidth( $board["title"],0,30,"...","utf-8");
							// 아예 글자수 자르고 대체택스트 넣는 함수
			    		}
